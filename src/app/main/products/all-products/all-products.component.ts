...
export class AllProductsComponent implements OnInit{
  ...
  all_products = [
    ...
    { product_id: 't-trackam-010', product_label: 'Trackam', product_description: 'A feed management system similar to Beezup, designed to improve e-commerce feed handling.', },
    { product_id: 't-emotiq-011', product_label: 'Emotiq', product_description: 'A feed management system similar to Beezup, designed to improve e-commerce feed handling.', },
